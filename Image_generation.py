...
def parse_args():
    ...
    parser.add_argument("--learned_embeds", type=str, default='output/VGGSound_features.bin',
                        help="Path to pretrained embedder")
    parser.add_argument("--learned_embeds_lora", type=str, default='output/lora_VGGSound_features.bin',
                        help="Path to pretrained embedder")
...
def inference(args):
    ...
    model = AudioToImage(args, accelerator).to(weight_dtype).eval()
