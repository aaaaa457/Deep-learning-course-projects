...
from models.AudioToImage.AudioToImage import AudioToImage
...
def parse_args():
    ...
    parser.add_argument("--data_dir", type=str, default='./data/VGGSound/',
    ...
    parser.add_argument("--run_name", type=str, default='AudioToImage',
...
def train():
    ...
    model = AudioToImage(args, accelerator).to(weight_dtype)
            ...
            if accelerator.sync_gradients:
                ...
                if global_step % 500 == 0:
                    ...
                    if accelerator.is_main_process:
                        ...
                        print(f"Checkpoint saved at step {global_step} to {save_path}")
    ...
    accelerator.wait_for_everyone()
    if accelerator.is_main_process:
        save_path_embedder = os.path.join(args.output_dir, f"VGGSound_features.bin")
        save_progress(accelerator.unwrap_model(model).embedder, save_path_embedder)
        print(f"Final model saved to {save_path_embedder}")
